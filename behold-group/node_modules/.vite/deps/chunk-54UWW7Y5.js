...
var $e5be200c675c3b3a$export$571b5131b7e65c11 = (0, import_react51.createContext)({});
...
function $e5be200c675c3b3a$var$useFormValidationStateImpl(props) {
  ...
  let clientError = (0, import_react51.useMemo)(() => {
  ...
  let serverErrors = (0, import_react51.useContext)($e5be200c675c3b3a$export$571b5131b7e65c11);
  let serverErrorMessages = (0, import_react51.useMemo)(() => {
  ...
  let [lastServerErrors, setLastServerErrors] = (0, import_react51.useState)(serverErrors);
  let [isServerErrorCleared, setServerErrorCleared] = (0, import_react51.useState)(false);
  if (serverErrors !== lastServerErrors) {
    setLastServerErrors(serverErrors);
    setServerErrorCleared(false);
  }
  let serverError = (0, import_react51.useMemo)(() => $e5be200c675c3b3a$var$getValidationResult(isServerErrorCleared ? [] : serverErrorMessages), [
    isServerErrorCleared,
    serverErrorMessages
  ]);
  let nextValidation = (0, import_react51.useRef)($e5be200c675c3b3a$export$dad6ae84456c676a);
  let [currentValidity, setCurrentValidity] = (0, import_react51.useState)($e5be200c675c3b3a$export$dad6ae84456c676a);
  let lastError = (0, import_react51.useRef)($e5be200c675c3b3a$export$dad6ae84456c676a);
  ...
  let [commitQueued, setCommitQueued] = (0, import_react51.useState)(false);
  (0, import_react51.useEffect)(commitValidation);
...
var $e5be200c675c3b3a$export$dad6ae84456c676a2 = {
  isInvalid: false,
  validationDetails: $e5be200c675c3b3a$export$aca958c65c314e6c2,
  validationErrors: []
};
var $e5be200c675c3b3a$export$571b5131b7e65c112 = (0, import_react54.createContext)({});
var $e5be200c675c3b3a$export$a763b9476acd3eb2 = "__formValidationState" + Date.now();
function $e5be200c675c3b3a$export$fc1a364ae1f3ff102(props) {
  if (props[$e5be200c675c3b3a$export$a763b9476acd3eb2]) {
    let { realtimeValidation, displayValidation, updateValidation, resetValidation, commitValidation } = props[$e5be200c675c3b3a$export$a763b9476acd3eb2];
    return {
      realtimeValidation,
      displayValidation,
      updateValidation,
  ...
  return $e5be200c675c3b3a$var$useFormValidationStateImpl2(props);
}
function $e5be200c675c3b3a$var$useFormValidationStateImpl2(props) {
  let { isInvalid, validationState, name, value, builtinValidation, validate, validationBehavior = "aria" } = props;
  if (validationState) isInvalid || (isInvalid = validationState === "invalid");
  let controlledError = isInvalid !== void 0 ? {
    isInvalid,
    validationErrors: [],
    validationDetails: $e5be200c675c3b3a$var$CUSTOM_VALIDITY_STATE2
  } : null;
  let clientError = (0, import_react54.useMemo)(() => {
    if (!validate || value == null) return null;
    let validateErrors = $e5be200c675c3b3a$var$runValidate2(validate, value);
    return $e5be200c675c3b3a$var$getValidationResult2(validateErrors);
  }, [
    validate,
    value
  ]);
  if (builtinValidation === null || builtinValidation === void 0 ? void 0 : builtinValidation.validationDetails.valid) builtinValidation = void 0;
  let serverErrors = (0, import_react54.useContext)($e5be200c675c3b3a$export$571b5131b7e65c112);
  let serverErrorMessages = (0, import_react54.useMemo)(() => {
    if (name) return Array.isArray(name) ? name.flatMap((name2) => $e5be200c675c3b3a$var$asArray2(serverErrors[name2])) : $e5be200c675c3b3a$var$asArray2(serverErrors[name]);
    return [];
  }, [
    serverErrors,
    name
  ]);
  let [lastServerErrors, setLastServerErrors] = (0, import_react54.useState)(serverErrors);
  let [isServerErrorCleared, setServerErrorCleared] = (0, import_react54.useState)(false);
  if (serverErrors !== lastServerErrors) {
    setLastServerErrors(serverErrors);
    setServerErrorCleared(false);
  }
  let serverError = (0, import_react54.useMemo)(() => $e5be200c675c3b3a$var$getValidationResult2(isServerErrorCleared ? [] : serverErrorMessages), [
    isServerErrorCleared,
    serverErrorMessages
  ]);
  let nextValidation = (0, import_react54.useRef)($e5be200c675c3b3a$export$dad6ae84456c676a2);
  let [currentValidity, setCurrentValidity] = (0, import_react54.useState)($e5be200c675c3b3a$export$dad6ae84456c676a2);
  let lastError = (0, import_react54.useRef)($e5be200c675c3b3a$export$dad6ae84456c676a2);
  let commitValidation = () => {
    if (!commitQueued) return;
    setCommitQueued(false);
    let error = clientError || builtinValidation || nextValidation.current;
    if (!$e5be200c675c3b3a$var$isEqualValidation2(error, lastError.current)) {
      lastError.current = error;
      setCurrentValidity(error);
    }
  };
  let [commitQueued, setCommitQueued] = (0, import_react54.useState)(false);
  (0, import_react54.useEffect)(commitValidation);
  let realtimeValidation = controlledError || serverError || clientError || builtinValidation || $e5be200c675c3b3a$export$dad6ae84456c676a2;
  let displayValidation = validationBehavior === "native" ? controlledError || serverError || currentValidity : controlledError || serverError || clientError || builtinValidation || currentValidity;
  return {
    realtimeValidation,
    displayValidation,
    updateValidation(value2) {
      if (validationBehavior === "aria" && !$e5be200c675c3b3a$var$isEqualValidation2(currentValidity, value2)) setCurrentValidity(value2);
      else nextValidation.current = value2;
    },
    resetValidation() {
      let error = $e5be200c675c3b3a$export$dad6ae84456c676a2;
      if (!$e5be200c675c3b3a$var$isEqualValidation2(error, lastError.current)) {
        lastError.current = error;
        setCurrentValidity(error);
      }
...
function $e5be200c675c3b3a$var$asArray2(v) {
  if (!v) return [];
  return Array.isArray(v) ? v : [
    v
  ];
}
function $e5be200c675c3b3a$var$runValidate2(validate, value) {
  if (typeof validate === "function") {
    let e = validate(value);
    if (e && typeof e !== "boolean") return $e5be200c675c3b3a$var$asArray2(e);
  }
  return [];
}
function $e5be200c675c3b3a$var$getValidationResult2(errors) {
  return errors.length ? {
    isInvalid: true,
    validationErrors: errors,
    validationDetails: $e5be200c675c3b3a$var$CUSTOM_VALIDITY_STATE2
...
function $e5be200c675c3b3a$var$isEqualValidation2(a, b) {
  if (a === b) return true;
  return !!a && !!b && a.isInvalid === b.isInvalid && a.validationErrors.length === b.validationErrors.length && a.validationErrors.every((a2, i) => a2 === b.validationErrors[i]) && Object.entries(a.validationDetails).every(([k, v]) => b.validationDetails[k] === v);
}
function $e5be200c675c3b3a$export$75ee7c75d68f5b0e2(...results) {
...
var useLatest = function useLatest2(value) {
  var ref = import_react56.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react57.default.useRef();
  return import_react57.default.useCallback(function(instance) {
...
export {
  ...
  $e5be200c675c3b3a$export$aca958c65c314e6c2 as $e5be200c675c3b3a$export$aca958c65c314e6c,
  $e5be200c675c3b3a$export$dad6ae84456c676a2 as $e5be200c675c3b3a$export$dad6ae84456c676a,
  $e5be200c675c3b3a$export$571b5131b7e65c112 as $e5be200c675c3b3a$export$571b5131b7e65c11,
  $e5be200c675c3b3a$export$a763b9476acd3eb2 as $e5be200c675c3b3a$export$a763b9476acd3eb,
  $e5be200c675c3b3a$export$fc1a364ae1f3ff102 as $e5be200c675c3b3a$export$fc1a364ae1f3ff10,
  $e5be200c675c3b3a$export$75ee7c75d68f5b0e2 as $e5be200c675c3b3a$export$75ee7c75d68f5b0e,
  index2 as index
};
//# sourceMappingURL=chunk-54UWW7Y5.js.map
